...
export function ProfilePage() {
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-center md:justify-start gap-2 text-text-muted">
                  ...
                  <span className="font-mono text-sm">{formatWalletAddress(user.walletAddress)}</span>
                </div>
                <div className="flex items-center justify-center md:justify-start gap-2 text-text-muted">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    <path
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-6">
              <div className="text-center">
                <p className="text-2xl font-bold text-primary">{user.totalCheckins}</p>
                <p className="text-xs text-text-muted">{t('achievements.totalCheckins')}</p>
              </div>
              <div className="text-center">
      ...
      {/* Statistics Grid */}
      <div>
        <h2 className="text-xl font-semibold text-white mb-4">{t('profile.statistics')}</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <Card.Body>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-text-muted mb-1">{t('profile.totalStaked')}</p>
          ...
          <Card>
            <Card.Body>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-text-muted mb-1">{t('profile.totalEarned')}</p>
            ...
            <Card.Body>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-white">{stats.completedStakes}</p>
                </div>
                <div className="text-4xl">✅</div>
              </div>
            </Card.Body>
          ...
          <Card>
            <Card.Body>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-text-muted mb-1">{t('achievements.perfectDays')}</p>
          ...
          <Card>
            <Card.Body>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-text-muted mb-1">
                    {t('profile.attractionsVisited', { defaultValue: 'Attractions' })}
                  </p>
                  <p className="text-2xl font-bold text-white">{stats.attractionsVisited}</p>
                </div>
      ...
      <Card>
        <Card.Header>
          <h2 className="text-xl font-semibold text-white">
            {t('profile.activitySummary', { defaultValue: 'Activity Summary' })}
          </h2>
        </Card.Header>
        <Card.Body>
          <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-white">
                    {t('profile.longestStreak', { defaultValue: 'Longest Streak' })}
                  </p>
                  <p className="text-sm text-text-muted">
                    {t('profile.personalBest', { defaultValue: 'Your personal best' })}
                  </p>
                </div>
              </div>
              <p className="text-xl font-bold text-primary">{user.maxStreak} days</p>
            </div>
            ...
            <div className="flex items-center justify-between py-3 border-b border-border-dark">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-white">
                    {t('profile.lotteryChances', { defaultValue: 'Lottery Chances' })}
                  </p>
                  <p className="text-sm text-text-muted">
                    {t('profile.availableNow', { defaultValue: 'Available now' })}
                  </p>
                </div>
              </div>
              <p className="text-xl font-bold text-primary">{user.lotteryChances}</p>
            </div>
            ...
            <div className="flex items-center justify-between py-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-white">
                    {t('profile.achievementRate', { defaultValue: 'Achievement Rate' })}
                  </p>
                  <p className="text-sm text-text-muted">
                    {t('profile.badgesCollected', { defaultValue: 'Badges collected' })}
                  </p>
                </div>
              </div>
              <p className="text-xl font-bold text-primary">{user.badges.length}/20</p>
            </div>
          </div>
        </Card.Body>
      </Card>
